...
Projeyi klonladıktan veya dosyayı bilgisayarınıza indirdikten sonra, terminal (veya komut satırı) üzerinden projenin bulunduğu klasöre giderek şu komutu çalıştırmanız yeterlidir:
